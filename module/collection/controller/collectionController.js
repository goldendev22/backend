...
exports.add = function(req,res) {
    ...
    collection.category = req.body.category ? req.body.category : false;
    collection.slottype = req.body.slottype ? JSON.stringify(req.body.slottype) : '';
    collection.status = 1;
...
exports.list = function(req,res) {
    ...
    var fields = ['name', 'description', 'symbol', 'image', 'item_count', 'category']
